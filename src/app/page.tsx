...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: '사주해은 전통 명리학 규칙으로 계산한 사주 원국 데이터를 기반으로 AI가 구조화된 설명을 제공해 일관성과 가독성을 높였습니다. 개인의 선택과 환경에 따라 결과는 달라질 수 있습니다.',
      },
    },
    {
      '@type': 'Question',
      ...
      <section className="bg-slate-950 text-slate-100 px-4 py-8 md:py-10">
        <div className="max-w-4xl mx-auto space-y-5">
          ...
          <p className="text-sm md:text-base leading-relaxed text-slate-200">
            사주해은 전통 명리학 계산 로직과 AI 해석 엔진을 결합해 누구나 쉽게 이해할 수 있는 사주 분석을 제공합니다. 생년월일시를 입력하면 사주 원국을 기준으로 오행 균형, 십신 구조, 일간 강약, 용신 방향을 빠르게 정리하고 현재 흐름에 맞는 운세 포인트를 확인할 수 있습니다.
          </p>
