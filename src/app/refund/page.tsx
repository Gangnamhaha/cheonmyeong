      ...
      <div className="mx-auto max-w-4xl">
        ...
        <section className="mt-4 rounded-2xl border border-[var(--border-color)] bg-[var(--bg-card)] p-6 shadow-[var(--card-shadow)] sm:p-8">
          ...
          <div className="mt-8 space-y-6 text-sm leading-7 text-[var(--text-secondary)]">
            <section>
              <h2 className="mb-2 text-lg font-semibold text-[var(--text-primary)]">1. 크레딧 환불</h2>
              <p>
                결제 완료 후 미사용 크레딧에 한해 결제일로부터 7일 이내 환불 요청이 가능합니다. 일부 크레딧이라도 사용된 경우, 사용분에 해당하는 금액 및 결제수단 수수료를 제외한 금액이 환불될 수 있습니다.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                정기 구독은 결제 주기 시작 후 7일 이내이며 사용 이력이 없는 경우 전액 환불이 가능합니다. 이미 분석 기능을 사용했거나 크레딧이 지급·소진된 경우에는 일할 계산 또는 사용량 기준으로 차감 후 환불될 수 있습니다. 구독 해지는 다음 결제일부터 과금이 중단됩니다.
              </p>
            </section>
