...
export const PLANS = {
  free: {
    ...
    price: 0,
    priceLabel: '무료',
    features: ['기본 사주 분석', 'AI 해석 이용권 제공', '오행·십신 차트'],
    popular: false,
    type: 'free' as const,
    stripePriceId: null,
  },
  starter: {
    ...
    price: 3900,
    priceLabel: '₩3,900',
    features: ['AI 해석 이용권', '모든 카테고리 해석', '후속 질문 가능', '궁합 분석'],
    popular: false,
  ...
  pro: {
    ...
    price: 9900,
    priceLabel: '₩9,900',
    features: ['AI 해석 이용권', '모든 카테고리 해석', '무제한 후속 질문', '궁합 분석', '대운 상세 해석'],
    popular: true,
    type: 'onetime' as const,
  ...
  premium_report_pro: {
    ...
    price: 25000,
    priceLabel: '₩25,000',
    features: ['gpt-4o 10개 카테고리 심층 분석', '대운 10년 타임라인', '세운 3년 전망', '맞춤 인생 조언', '프리미엄 DOCX 다운로드'],
    popular: false,
    type: 'onetime' as const,
    stripePriceId: null,
  },
  ...
  unlimited: {
    ...
    price: 29900,
    priceLabel: '₩29,900',
    features: ['AI 해석 이용권', '모든 기능 무제한', '우선 응답', '월간 운세 리포트'],
    popular: false,
    type: 'onetime' as const,
  ...
  sub_basic: {
    ...
    price: 4900,
    priceLabel: '₩4,900/월',
    features: ['매월 이용권 자동 지급', '모든 카테고리 해석', '후속 질문 가능', '궁합 분석'],
    popular: false,
  ...
  sub_pro: {
    ...
    price: 9900,
    priceLabel: '₩9,900/월',
    features: ['매월 이용권 자동 지급', '모든 기능 무제한', '대운 상세 해석', '우선 응답'],
    popular: true,
    type: 'subscription' as const,
  ...
  sub_premium: {
    ...
    price: 19900,
    priceLabel: '₩19,900/월',
    features: ['매월 이용권 자동 지급', '모든 기능 무제한', '우선 응답', '월간 운세 리포트', '1:1 상담'],
    popular: false,
    type: 'subscription' as const,
  ...
  sub_basic_annual: {
    ...
    price: 47000,
    priceLabel: '₩47,000/년',
    features: ['매월 이용권 자동 지급', '모든 카테고리 해석', '후속 질문 가능', '궁합 분석', '월 ₩3,917 (20% 할인)'],
    popular: false,
    type: 'subscription' as const,
  ...
  sub_pro_annual: {
    ...
    price: 95000,
    priceLabel: '₩95,000/년',
    features: ['매월 이용권 자동 지급', '모든 기능 무제한', '대운 상세 해석', '우선 응답', '월 ₩7,917 (20% 할인)'],
    popular: true,
    type: 'subscription' as const,
  ...
  bundle_50: {
    ...
    price: 5900,
    priceLabel: '₩5,900',
    features: ['AI 해석 이용권', '모든 카테고리 해석', '후속 질문 가능', '궁합 분석', '가성비 번들'],
    popular: false,
    type: 'onetime' as const,
    stripePriceId: null,
  },
  bundle_200: {
    ...
    price: 15900,
    priceLabel: '₩15,900',
    features: ['AI 해석 이용권', '모든 기능 무제한', '대운 상세 해석', '우선 응답', '최고 가성비'],
    popular: false,
    type: 'onetime' as const,
    stripePriceId: null,
  },
